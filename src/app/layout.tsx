    ...
    <html lang="es">
      <body>
        <div className="min-h-screen pb-20 md:pb-0">
          ...
          {/* Mobile bottom nav */}
          <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200 bg-white/90 backdrop-blur-lg md:hidden">
            <div className="mx-auto grid max-w-5xl grid-cols-4 px-2 py-1">
              <MobileNavLink
                href="/"
                label="Semana"
